...
interface ApiService {
    ...
    @POST("favourite/add-favourite-restaurant/{restaurantId}") fun addFavouriteRestaurant(@Path ("restaurantId") restaurantId: String): Call<FavouriteRestaurantModelResponse>
}